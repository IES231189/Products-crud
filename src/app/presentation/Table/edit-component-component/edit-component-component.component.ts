...
@Component({
  selector: 'app-edit-component-component',
  templateUrl: './edit-component-component.component.html',
  styleUrl: './edit-component-component.component.css'
})
export class EditComponentComponentComponent {
